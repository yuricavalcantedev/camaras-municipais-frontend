...
@Component({
  selector: 'app-voting-panel-left',
  templateUrl: './voting-panel-left.component.html',
  styleUrls: ['./voting-panel-left.component.css']
})
export class VotingPanelLeftComponent implements OnInit {
  inFullScren = false;
  loading = false;
